                ...
                for date in all_requested_dates:
                    ...
                    for record in records:
                        if record.district is not None:
                            ...
                            self.__data[date][record.district]['infections_new_100k'] = record.infections_new / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['infections_active_100k'] = record.infections_active / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['infections_new_7_100k'] = record.infections_new_7 / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['infections_new_14_100k'] = record.infections_new_14 / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['infections_new_65_age_100k'] = record.infections_new_65_age / (self.__population[record.district] / 100000)
                ...
                for date in all_requested_dates:
                    ...
                    for record in records:
                        if record.district is not None:
                            ...
                            self.__data[date][record.district]['vaccination_1_dose_day_100k'] = record.dose_1_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_1_dose_alltime'] = record.dose_1_alltime
                            self.__data[date][record.district]['vaccination_1_dose_alltime_100'] = record.dose_1_alltime / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_2_dose_day'] = record.dose_2_day
                            self.__data[date][record.district]['vaccination_2_dose_day_100k'] = record.dose_2_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_2_dose_alltime'] = record.dose_2_alltime
                            self.__data[date][record.district]['vaccination_2_dose_alltime_100'] = record.dose_2_alltime / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_3_dose_day'] = record.dose_3_day
                            self.__data[date][record.district]['vaccination_3_dose_day_100k'] = record.dose_3_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_3_dose_alltime'] = record.dose_3_alltime
                            self.__data[date][record.district]['vaccination_3_dose_alltime_100'] = record.dose_3_alltime / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_4_dose_day'] = record.dose_4_day
                            self.__data[date][record.district]['vaccination_4_dose_day_100k'] = record.dose_4_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_4_dose_alltime'] = record.dose_4_alltime
                            self.__data[date][record.district]['vaccination_4_dose_alltime_100'] = record.dose_4_alltime / (self.__population[record.district] / 100000)
                            ...
                            self.__data[date][record.district]['vaccination_doses_day_100k'] = record.doses_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['vaccination_doses_alltime'] = record.doses_alltime
                            self.__data[date][record.district]['vaccination_doses_alltime_100k'] = record.doses_alltime / (self.__population[record.district] / 100000)
                ...
                for date in all_requested_dates:
                    ...
                    for record in records:
                        if record.district is not None:
                            ...
                            self.__data[date][record.district]['deaths_day_100k'] = record.deaths_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['deaths_alltime_100k'] = record.deaths_alltime / (self.__population[record.district] / 100000)
                ...
                for date in all_requested_dates:
                    ...
                    for record in records:
                        if record.district is not None:
                            ...
                            self.__data[date][record.district]['pcr_tests_day_100k'] = pcr_tests_day / (self.__population[record.district] / 100000)
                            self.__data[date][record.district]['pcr_tests_alltime_100k'] = pcr_tests_alltime / (self.__population[record.district] / 100000)
                            ...
                            # self.__data[date][record.district]['prirustek_korekce_sto_tisic'] = prirustek_korekce / (self.__population[record.district] / 100000)
                            # self.__data[date][record.district]['celkem_korekce_sto_tisic'] = celkem_korekce / (self.__population[record.district] / 100000)
